...
expected_config_keys='STRIKEFLOW_RESPONSE_AGENT_ID STRIKEFLOW_RESPONSE_BACKEND_IMAGE STRIKEFLOW_RESPONSE_COMMAND_IDS STRIKEFLOW_RESPONSE_HMAC_KEY_ID STRIKEFLOW_RESPONSE_HMAC_SECRET_FILE STRIKEFLOW_RESPONSE_NOT_BEFORE STRIKEFLOW_RESPONSE_PROJECT_IDS STRIKEFLOW_RESPONSE_PUBLISHER_ENABLED STRIKEFLOW_RESPONSE_RECIPIENT_ID STRIKEFLOW_RESPONSE_STR94_ISSUE_ID STRIKEFLOW_RESPONSE_WEBHOOK_URL STRIKEFLOW_RESPONSE_WORKSPACE_ID STRIKEFLOW_RESPONSE_WORKSPACE_KEY'
...
if grep -Eq '^STRIKEFLOW_RESPONSE_(PUBLISHER_ENABLED=true|BACKEND_IMAGE=.+|WEBHOOK_URL=.+|HMAC_SECRET=.+|HMAC_SECRET_FILE=.+|HMAC_KEY_ID=.+|WORKSPACE_ID=.+|WORKSPACE_KEY=.+|PROJECT_IDS=.+|COMMAND_IDS=.+|RECIPIENT_ID=.+|AGENT_ID=.+|STR94_ISSUE_ID=.+|NOT_BEFORE=.+)' "$config_file"; then
