...
| `avatar_url` | `agent.avatar_url` | none; an explicit non-empty value is preserved, while omitted/empty/whitespace-only stores NULL | catalog/listing UI only — NOT the runtime prompt |
